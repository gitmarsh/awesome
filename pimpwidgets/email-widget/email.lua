...
watch(
    "python /home/marhearn/.config/awesome/pimpwidgets/email-widget/count_unread_emails.py", 20,
    function(_, stdout)
...
local function show_emails()
    awful.spawn.easy_async([[bash -c 'python /home/marhearn/.config/awesome/pimpwidgets/email-widget/read_unread_emails.py']],
        function(stdout)
            naughty.notify{
                text = stdout,
                title = "Unread Emails",
